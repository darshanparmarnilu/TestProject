...
class WorkViewController: UIViewController {
   ...
   // var arrWork = ["Running","Push-Ups","Strecthing","Playing","Push-Ups","Strecthing","Playing"]
    ...
    override func viewDidLoad() {
        ...
        let obj1 = WorkOut(arrColors: UIColor.red, WorkType: "Running", Switch: false, Slider: 0)
        let obj2 = WorkOut(arrColors: UIColor.orange, WorkType: "Push-Ups", Switch: false, Slider: 0)
        let obj3 = WorkOut(arrColors: UIColor.yellow, WorkType: "Strecthing", Switch: false, Slider: 0)
        let obj4 = WorkOut(arrColors: UIColor.green, WorkType: "Playing", Switch: false, Slider: 0)
        let obj5 = WorkOut(arrColors: UIColor.blue, WorkType: "Gamming", Switch: false, Slider: 0)
        let obj6 = WorkOut(arrColors: UIColor.purple, WorkType: "Singing", Switch: false, Slider: 0)
        let obj7 = WorkOut(arrColors: UIColor.brown, WorkType: "Swiming", Switch: false, Slider: 0)
        let obj8 = WorkOut(arrColors: UIColor.black, WorkType: "Catching", Switch: false, Slider: 0)
        let obj9 = WorkOut(arrColors: UIColor.gray, WorkType: "Eating", Switch: false, Slider: 0)
        let obj10 = WorkOut(arrColors: UIColor.white, WorkType: "Dancing", Switch: false, Slider: 0)
        let obj11 = WorkOut(arrColors: UIColor.magenta, WorkType: "Putting", Switch: false, Slider: 0)
